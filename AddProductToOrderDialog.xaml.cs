...
{
    public partial class AddProductToOrderDialog : Window
    {
        ...
        public AddProductToOrderDialog()
        {
            InitializeComponent();
        ...
        private void LoadProducts()
        {
            try
            {
                ...
                string query = "SELECT id, nom, prix FROM produits ORDER BY nom";
        ...
        {
            if (cmbProduct.SelectedValue != null && cmbProduct.SelectedItem is DataRowView selectedRow)
            {
                int productId = Convert.ToInt32(cmbProduct.SelectedValue);

                // Mettre à jour le prix affiché
                decimal price = Convert.ToDecimal(selectedRow["prix"]);
                txtPrice.Text = price.ToString("C2", System.Globalization.CultureInfo.CreateSpecificCulture("fr-FR"));
                SelectedPrice = price;
        ...
        private void UpdateTotalPrice()
        {
            if (cmbQuantity.SelectedItem != null)
            {
                ...
                txtTotalPrice.Text = totalPrice.ToString("C2", System.Globalization.CultureInfo.CreateSpecificCulture("fr-FR"));
            }
            else
            {
